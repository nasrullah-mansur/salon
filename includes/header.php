                                    ...
                                    <div class="widget woocommerce widget_shopping_cart">
                                        <div class="hide_cart_widget_if_empty">
                                            <div class="widget_shopping_cart_content">
                                                ...
                                                <div class="h-30"></div>
                                                <div class="text_center price_card">
                                                    <a href="#" class="sc_button sc_button_size_small sc_button_style_filled ">
                                                        <div>
                                                            <span class="first">View Card</span>
                                                            <span class="second">View Card</span>
                                                        </div>
                                                    </a>
                                                    <a href="#" class="sc_button sc_button_size_small blue sc_button_style_filled ">
                                                        <div>
                                                            <span class="first">Checkout</span>
                ...
                <div class="menu_main_wrap">
                    <nav class="menu_main_nav_area">
                        <ul class="menu_main_nav">
                            <li class="menu-item"><a class="disable" href="#about">About</a></li>
                            <li class="menu-item"><a class="disable" href="#services">Services</a></li>
                            <li class="menu-item"><a class="disable" href="#portfolio">Portfolio</a></li>
