                                        ...
                                        <div class="wrapper">
                                            <div class="sc_section sc_section_block aligncenter max_width cu_width-970">
                                                <div class="sc_section_inner">
                                                    <h6 class="sc_section_subtitle sc_item_subtitle">Booking Service</h6>
                                                    <h2 class="sc_section_title sc_item_title line_hide">Select your service</h2>
                                                    <div class="h-30"></div>

                                                    <div class="shortcodespg">
                                                        <div class="sc_section_content_wrap choose_time">
                                                            <div class="columns_wrap sc_columns columns_nofluid cu_mrg_6">
                                                                <div class="column-1_3 sc_column_item">
                                                                    <a href="#" class="sc_button sc_button_square sc_button_size_medium">
                                                                        <div>
                                                                            <span class="first">Braids / Trese Cheve</span>
                                                                            <span class="second">Braids / Trese Cheve</span>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                <div class="column-1_3 sc_column_item">
                                                                    <a href="#" class="sc_button sc_button_square sc_button_size_medium">
                                                                        <div>
                                                                            <span class="first">Hair Cutting/ Koupe Cheve</span>
                                                                            <span class="second">Hair Cutting/ Koupe Cheve</span>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                <div class="column-1_3 sc_column_item">
                                                                    <a href="#" class="sc_button sc_button_square sc_button_size_medium">
                                                                        <div>
                                                                            <span class="first">Kids Hair</span>
                                                                            <span class="second">Kids Hair</span>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                <div class="column-1_3 sc_column_item">
                                                                    <a href="#" class="sc_button sc_button_square sc_button_size_medium">
                                                                        <div>
                                                                            <span class="first">Shampooing</span>
                                                                            <span class="second">Shampooing</span>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                            </div>
