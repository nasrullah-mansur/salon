                ...
                <div class="panel_top">
                    <nav class="menu_main_nav_area">
                        <ul class="menu_main_nav">
                            ...
                            <li class="menu-item current-menu-item"><a href="booking.html">Booking</a></li>
                ...
                <div class="top_panel_middle">
                    <div class="content_wrap">
                        <div class="column-1_3 contact_logo">
                            <div class="logo">
                                <a href="index.html"><img src="images/Logo.png" class="logo_main" alt="" width="238" height="56"><img src="images/Logo.png" class="logo_fixed" alt="" width="238" height="56"></a>
                            </div>
                        </div>
                                        ...
                                        <div class="wrapper">
                                            <div class="sc_section sc_section_block aligncenter max_width cu_width-970">
                                                <div class="sc_section_inner">
                                                    <h6 class="sc_section_subtitle sc_item_subtitle">Booking Time</h6>
                                                    <h2 class="sc_section_title sc_item_title line_hide">Select existing time</h2>
                                                    <div class="h-30"></div>
                                                            ...
                                                            <div class="columns_wrap sc_columns columns_nofluid cu_mrg_6">
                                                                <div class="column-1_3 sc_column_item">
                                                                    <a href="#" class="sc_button sc_button_square sc_button_size_medium">
                                                                        <div>
                                                                            <span class="first">9:00AM - 10PM</span>
                                                                            <span class="second">9:00AM - 10PM</span>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                <div class="column-1_3 sc_column_item">
